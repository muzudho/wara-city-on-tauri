...
export function loadSourceTilemapCollection(srcTilemaps: Reactive<SourceTilemapCollection>, srcTileCollection: Reactive<SourceTileCollection>){
    ...
    srcTilemaps.tilemapDict["outBorder"] = reactive<TilemapData>({
    ...
    srcTilemaps.tilemapDict["sea"] = reactive<TilemapData>({
    ...
    srcTilemaps.tilemapDict["seaBorder"] = reactive<TilemapData>({
    ...
    srcTilemaps.tilemapDict["wastelandRoad"] = reactive<TilemapData>({    // 荒地の道
    ...
    srcTilemaps.tilemapDict["wastelandBorder"] = reactive<TilemapData>({
...
// ８方向タイル（無印）を切り抜く
function cropEightDirectionTileDict(srcTileCollection: Reactive<SourceTileCollection>, tilemap: string) : Ref<TileDict> {
...
// ４方向タイル（A型）を切り抜く
function cropFourDirectoryTileDict(srcTileCollection: Reactive<SourceTileCollection>, tilemap: string) : Ref<TileDict> {
    const tileDict = ref<TileDict>({});
